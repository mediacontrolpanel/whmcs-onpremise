...
function mcp_str_slug($title, $separator = '-'){
	$title = mcp_ascii($title);
...
function mcp_ascii($value, $language = 'en')
{
	$charsArray = [
		'0'    => ['°', '₀', '۰', '０'],
		'1'    => ['¹', '₁', '۱', '１'],
...
add_hook('EmailTplMergeFields', 1, function($vars) {
	...
	$merge_fields['mediacp_publish_name'] = "MediaCP Publish Name";
	$merge_fields['mediacp_slug'] = "MediaCP Publish Slug";
	return $merge_fields;
});
